...
public class ModerateUserAdapter extends RecyclerView.Adapter<ModerateUserAdapter.UserViewHolder> {
    ...
    public ModerateUserAdapter(List<User> userList, OnItemClickListener listener) {
    ...
    static class UserViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(User user, OnItemClickListener listener) {
            ...
            resultTextView.setText("Moderate");
