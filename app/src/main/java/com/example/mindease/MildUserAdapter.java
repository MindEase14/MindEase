...
public class MildUserAdapter extends RecyclerView.Adapter<MildUserAdapter.UserViewHolder> {
    ...
    public MildUserAdapter(List<User> userList, OnItemClickListener listener) {
