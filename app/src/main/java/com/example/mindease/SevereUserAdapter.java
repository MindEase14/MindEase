...
public class SevereUserAdapter extends RecyclerView.Adapter<SevereUserAdapter.UserViewHolder> {
    ...
    public SevereUserAdapter(List<User> userList, OnItemClickListener listener) {
